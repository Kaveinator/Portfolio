...
namespace Portfolio.Projects {
    ...
    public class ProjectInfo : ProjectsTable.SQLiteRow, IPageModel {
        public override IEnumerable<IDbCell> Fields => new IDbCell[] { ProjectId, OrginizationId, UrlName, Name, Role, ThumbnailOverrideHref, HeaderOverrideHref, BriefText, OverviewMarkdown, IsPublished };
